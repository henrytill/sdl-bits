...
static const char *const FONT_FILE =
    "./EBGaramond12/EBGaramond12-e608414f52e532b68e2182f96b4ce9db35335593/fonts/ttf/"
...
int main(int argc, char *argv[]) {
    ...
    SDL_Surface *surface = TTF_RenderText_Blended(font, char_codes, color_foreground);
    if (surface == NULL) {
        error = FAILURE;
        goto out;
    }
